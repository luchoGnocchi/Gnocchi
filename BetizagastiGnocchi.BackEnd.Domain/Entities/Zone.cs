...
namespace BetizagastiGnocchi.BackEnd.Domain.Entities
{
    public class Zone
    {
		...
		public virtual List<Zone> SubZones { get; set; } = new List<Zone>();
        ...
        public void avaibleToAddNewVehicle()
        {

            if (MaxCapacity <= UsedCapacity)
            {
                throw new ZoneMaximunVioledException();
