...
export class BatchService {
  ...
  getBatchs(): Observable<Array<Batch>> {
    return this._httpService.get(this.urlBatch())
      .map((response: Response) => <Array<Batch>>response.json())
