...
namespace BetizagastiGnocchi.BackEnd.Test
{
    public class SetUp
    {
		...
		protected UserRol AdminRol()
		{
			UserRol rolo = new UserRol { UType = UserType.Admin };
			rolo.ActionOperations.Add(new ActionOperation { Name = "Vehicle.Add" });

			rolo.ActionOperations.Add(new ActionOperation { Name = "User.Add" });
			rolo.ActionOperations.Add(new ActionOperation { Name = "User.Update" });
			rolo.ActionOperations.Add(new ActionOperation { Name = "User.UpdateById" });
