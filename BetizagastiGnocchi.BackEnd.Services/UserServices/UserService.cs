...
namespace BetizagastiGnocchi.BackEnd.Services.UserService
{
    public class UserService : GenericService<User>, IUserService
    {
        ...
        public UserService(IRepository<User> genericRepository, ILogService logService) :base(genericRepository)
        ...
        {
          return unitOfWork.UserRepository.GetAll().Where(u => u.Token.ToString() == token).FirstOrDefault();
        }
